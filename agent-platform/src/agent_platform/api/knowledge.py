...
from agent_platform.api.dependencies import KnowledgeIngestionServiceDep, KnowledgeServiceDep
...
class KnowledgeBaseCreate(BaseModel):
    key:str; name:str; description:str=""; metadata:dict=Field(default_factory=dict); enabled:bool=True
class KnowledgeDocumentCreate(BaseModel):
    title:str; content:str; media_type:str="text/plain"; source_uri:str|None=None; metadata:dict=Field(default_factory=dict)
class KnowledgeIngestRequest(BaseModel):
    chunk_size:int=Field(default=1200,gt=0,le=10000); overlap:int=Field(default=200,ge=0,le=5000); embed:bool=True
