...
def get_embedding_provider() -> EmbeddingProvider:
    ...
    return HashEmbeddingProvider(dimensions=settings.embedding_dimensions, model=settings.embedding_model)


EmbeddingProviderDep = Annotated[EmbeddingProvider, Depends(get_embedding_provider)]


async def get_knowledge_ingestion_service(repository: KnowledgeRepositoryDep, embedding_provider: EmbeddingProviderDep) -> KnowledgeIngestionService:
    return KnowledgeIngestionService(repository, embedding_provider)
...
async def get_knowledge_file_service(
    ...
    ingestion_service: KnowledgeIngestionServiceDep,
) -> KnowledgeFileService:
    return KnowledgeFileService(knowledge_service, ingestion_service)
