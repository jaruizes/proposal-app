...
SkillRegistryDep=Annotated[SkillRegistry,Depends(get_skill_registry)]; AgentRegistryDep=Annotated[AgentRegistry,Depends(get_agent_registry)]; KnowledgeServiceDep=Annotated[KnowledgeService,Depends(get_knowledge_service)]
...
def get_agent_runtime(agents:AgentRegistryDep,skills:SkillRegistryDep,executions:ExecutionRepositoryDep,model_provider:ModelProviderDep)->AgentRuntime: return AgentRuntime(agents,skills,executions,model_provider)
