...
export class AppComponent {
  ...
  agentPhaseLabel(phase:string){const labels:Record<string,string>={ANALYSIS:'Entendimiento y calificación',SOLUTION:'Propuesta de solución y plan de delivery',PROPOSAL:'Documento de oferta',SLIDE_PLAN:'Hilo de presentación',PRESENTATION:'Generación de presentación'};return labels[phase]||phase;}
  ...
  private newDraft(){return{name:'',customer:'',presentationLanguage:'Español',inputDriveFolder:'',outputDriveFolder:'',presentationName:'',generatePresentation:false,provider:'ANTHROPIC',models:{analysis:'claude-sonnet-4-6',solutionArchitecture:'claude-sonnet-4-6',deliveryPlanning:'claude-sonnet-4-6',proposal:'claude-sonnet-4-6',slidePlanning:'claude-sonnet-4-6',presentation:'claude-sonnet-4-6'},proposalSections:structuredClone(this.svc.defaultProposalSections) as ProposalSectionConfig[],sections:structuredClone(this.svc.defaultSections) as SectionConfig[]};}
}
